...
const RegisterTenantForm = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Inscription Locataire - Flat</title>
      </Helmet>
        ...
        >
          <div className="bg-card p-8 rounded-xl border shadow-sm">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-foreground">Créer un compte Locataire</h1>
              <p className="text-muted-foreground">Rejoignez-nous pour trouver votre prochain logement.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="p-4 bg-muted rounded-md text-center text-sm text-muted-foreground h-16 flex items-center justify-center">
                  [ Espace CAPTCHA ]
                </div>
              </div>
