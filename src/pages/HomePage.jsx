  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Flat simplifie, digitalise et sécurise la rencontre entre locataires et propriétaires. Créez votre compte pour commencer."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-extrabold text-foreground tracking-tight mb-4">
              La location immobilière, <br />
              enfin simple et sécurisée.
            </h1>
          ...
          <div className="grid grid-cols-1 gap-8 max-w-3xl mx-auto justify-items-center">
            ...
            >
              <RoleCard
                ...
                description="Créez votre dossier unique pour trouver le logement de vos rêves."
                link="/inscription"
              />
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Qu'est-ce que <span className="text-primary">Flat</span> ?
            </h2>
            <p className="text-lg text-muted-foreground mb-4">
              Flat est une plateforme transactionnelle dédiée à la location
              longue durée. Contrairement aux portails d'annonces traditionnels,
              nous ne listons aucun bien publiquement. Dites nous ce que vous
              cherchez et retrouvez nos propositions directement dans votre
              tableau de bord.
            </p>
            <p className="text-lg text-muted-foreground">
              Notre mission est de digitaliser et sécuriser l'ensemble du
              processus de location, de la création du dossier à
              l'enregistrement du bail, pour une expérience simple, rapide et
              transparente.{" "}
            </p>
          </motion.div>
          <motion.div
            ...
            <Card className="p-4 bg-background">
              <CardContent className="p-0">
                <img
                  ...
                  alt="Dashboard de l'application Flat montrant une interface épurée"
                  src="https://horizons-cdn.hostinger.com/b259af18-cdad-4c02-bd6d-01c633eab60a/51960842-plU8D.webp"
                />
              </CardContent>
            </Card>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Nous transformons la location
            </h2>
            <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">
              Adieu la paperasse et le stress. Bonjour l'efficacité et la
              sérénité.
            </p>
          </div>
            ...
            >
              <Card className="h-full border-primary/30 bg-primary/5">
                ...
                <CardContent className="space-y-3 text-foreground">
                  ...
                  <p>
                    ✓ Signature électronique de bail sécurisée et enregistrement
                    du bail digitalisé.
                  </p>
      ...
      <section className="py-20 bg-muted/40">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground mt-4 max-w-3xl mx-auto">
              Que vous cherchiez un logement ou un locataire, Flat vous
              simplifie la vie.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8 max-w-5xl mx-auto justify-items-center">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Créez une seule fois votre dossier de location complet et
                sécurisé. Recevez des propositions de biens qui vous
                correspondent et oubliez les recherches interminables.
              </p>
              <Link to="/inscription">
